...
export default function ContractorRegistrationPage() {
    ...
    const serviceOptions = ["Commercial", "Residential", "Office"];
                        ...
                        <div className="mx-auto max-w-lg mt-20">
                            <Card className="shadow-sm">
                                <CardHeader className="pb-4">
                                    <CardTitle className="text-2xl font-semibold text-gray-900 text-center" >Contractor Information</CardTitle>
                                </CardHeader>
                                <CardContent className="space-y-6">
                                    <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
                                        ...
                                        <div className="space-y-3">
                                            <Label htmlFor="bio" className="text-sm font-medium">Add Bio</Label>
                                            <Textarea
                                                id="bio"
                                        ...
                                        <div className="space-y-3">
                                            <div className="flex items-center justify-between">
                                                <Label className="text-sm font-medium">Add Service Areas</Label>
                                                <Button
                                                    type="button"
                                                    variant="outline"
                                                    size="sm"
                                                    ...
                                                    <div key={field.id} className="flex gap-2">
                                                        <Input
                                                            ...
                                                            {...register(`serviceAreas.${index}`, {
                                                                required: index === 0 ? 'At least one service area is required' : false,
                                                            })}
                                                            className="flex-1"
                                                        />
                                                        {fields.length > 1 && (
                                        ...
                                        <Button
                                            type="submit"
                                            className="w-full bg-green-600 cursor-pointer hover:bg-green-700 text-white font-medium py-3"
                                            size="lg"
                                        >
                                            Continue
                                        </Button>
