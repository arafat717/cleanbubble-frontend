            ...
            <Card className="w-full max-w-sm bg-white rounded-3xl overflow-hidden shadow-lg">
                ...
                <div className="px-4 sm:px-6">
                    ...
                    <div className="flex gap-3">
                        <Link href={`/dashboard/user/my-order/complete-order/${21}`}><Button className="flex-1 border bg-[#319E60] hover:bg-[#115e32] cursor-pointer text-white rounded-full py-2 sm:py-3 text-sm sm:text-base font-medium">
                            Make Payment
                        </Button></Link>
                    </div>
                </div>
